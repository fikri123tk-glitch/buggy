...
function runPython(code) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    try {
      ...
      // if / elif / else — basic single-line body
      const ifMatch = line.match(/^if\s+(.+):$/);
      if (ifMatch) {
        // skip for now — just note it
        continue;
      }
  ...
  intro: [
    {
      ...
      explanation: "print() adalah perintah untuk menampilkan teks. Teks harus diapit tanda kutip.",
    },
    {
      id: 2, type: "fill",
      title: "Print Teks",
